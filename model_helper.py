...
def predict_model(model, device, classes, test_loader, lr, weight_decay, model_name, tested_parameter,save_flg = True):
    ...
    disp.ax_.tick_params(axis='x', labelsize=13)
    disp.ax_.tick_params(axis='y', labelsize=13)
    disp.ax_.set_xlabel(disp.ax_.get_xlabel(), fontsize=14)
    disp.ax_.set_ylabel(disp.ax_.get_ylabel(), fontsize=14)
    plt.tight_layout()
